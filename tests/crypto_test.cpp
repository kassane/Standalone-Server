...
const vector<pair<string, string>> base64_string_tests = {
    ...
    {"The itsy bitsy spider climbed up the waterspout.\r\nDown came the "
     ...
     "VGhlIGl0c3kgYml0c3kgc3BpZGVyIGNsaW1iZWQgdXAgdGhlIHdhdGVyc3BvdXQuDQpEb3duI"
     "GNhbWUgdGhlIHJhaW4NCmFuZCB3YXNoZWQgdGhlIHNwaWRlciBvdXQuDQpPdXQgY2FtZSB0aG"
     "Ugc3VuDQphbmQgZHJpZWQgdXAgYWxsIHRoZSByYWluDQphbmQgdGhlIGl0c3kgYml0c3kgc3B"
     "pZGVyIGNsaW1iZWQgdXAgdGhlIHNwb3V0IGFnYWluLg=="}};
...
int main() {
  ...
  // Testing iterations
  ASSERT(Crypto::to_hex_string(Crypto::sha1("Test", 1)) ==
         "640ab2bae07bedc4c163f679a746f7ab7fb5d1fa");
  ASSERT(Crypto::to_hex_string(Crypto::sha1("Test", 2)) ==
         "af31c6cbdecd88726d0a9b3798c71ef41f1624d5");
  stringstream ss("Test");
  ASSERT(Crypto::to_hex_string(Crypto::sha1(ss, 2)) ==
         "af31c6cbdecd88726d0a9b3798c71ef41f1624d5");

  ASSERT(Crypto::to_hex_string(
             Crypto::pbkdf2("Password", "Salt", 4096, 128 / 8)) ==
         "f66df50f8aaa11e4d9721e1312ff2e66");
  ASSERT(Crypto::to_hex_string(
             Crypto::pbkdf2("Password", "Salt", 8192, 512 / 8)) ==
         "a941ccbc34d1ee8ebbd1d34824a419c3dc4eac9cbc7c36ae6c7ca8725e2b618a6ad22"
         "241e787af937b0960cf85aa8ea3a258f243e05d3cc9b08af5dd93be046c");
}
